...
class LLMService:
    ...
    async def processar_mensagem(
        ...
        system_prompt = (
            ...
            "     * 2º Chamado Recente de Calor: 'ifttt_action': 'freezer', 'intencao': 'ligar_resfriamento' (T-Low)\n"
            "     * 3º Chamado ou mais Recente de Calor: 'ifttt_action': 'freezer', 'intencao': 'ligar_resfriamento' (T-Freezer)\n"
