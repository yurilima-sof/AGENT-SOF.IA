...
class LLMService:
    ...
    async def processar_mensagem(self, mensagem: str, id_grupo: str) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "{\n"
            "  \"intencao\": \"ligar_resfriamento\" | \"ligar_aquecimento\" | \"desligar_dispositivos\" | \"ligar_dispositivos\" | \"sem_acao\",\n"
            "  \"ifttt_action\": \"freezer\" | \"esquentar\" | \"off\" | \"ligar\" | null,\n"
            ...
            "3. Se o usuário pedir para desligar as máquinas/equipamentos, ou informar que a revenda está fechada/fechando:\n"
            "   - 'intencao': 'desligar_dispositivos'\n"
            "   - 'ifttt_action': 'off'\n"
            "4. Se o usuário pedir para ligar as máquinas/equipamentos/ar-condicionado de forma geral (sem especificar calor/frio):\n"
            "   - 'intencao': 'ligar_dispositivos'\n"
            "   - 'ifttt_action': 'ligar'\n"
            "5. Qualquer outra conversa (saudações, agradecimentos, perguntas gerais):\n"
            "   - 'intencao': 'sem_acao'\n"
            "   - 'ifttt_action': null\n\n"
